...
class _MockService implements MockService {
  _MockService(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  Future<TicketOfferModel> getAllTicketOffers() async {
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<TicketOfferModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = TicketOfferModel.fromJson(_result.data!);
    return value;
  }
  ...
  Future<TicketModel> getAllTickets() async {
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<TicketModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
